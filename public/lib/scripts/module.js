...
page('signup', function (context, next) {
    var interior = yo(_templateObject);
...
},{"_process":14,"path-to-regexp":13}],12:[function(require,module,exports){
